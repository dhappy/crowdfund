...
class BountiesControllerTest < ActionController::TestCase
  ...
  test "should create bounty" do
    assert_difference('Bounty.count') do
      post :create, bounty: { amount: @bounty.amount, currency: @bounty.currency, expiration: @bounty.expiration, poster: @bounty.poster }
    end
  ...
  test "should update bounty" do
    patch :update, id: @bounty, bounty: { amount: @bounty.amount, currency: @bounty.currency, expiration: @bounty.expiration, poster: @bounty.poster }
    assert_redirected_to bounty_path(assigns(:bounty))
  end
